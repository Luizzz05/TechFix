                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="<?php echo htmlspecialchars($row_class); ?>">
                                ...
                                <td>
                                    <div class='d-flex'>
                                    <button class='btn action-button edit-button me-2' data-bs-toggle='modal' data-bs-target='#exampleModal' onclick='editService(" . json_encode($linha) . ")'><i class='fas fa-pencil-alt'></i></button>
